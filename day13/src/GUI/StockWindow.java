...
public class StockWindow extends JFrame implements ActionListener {
   JLabel labelId = new JLabel("     id");
    ...
    public StockWindow(String text, ItemDTO item) {
    	super(text);
    	this.item = item;
    	this.text = text;
    	display();
       ...
       String state = buttonaccept.getText();
        ...
        case "수정":
        	...
        	if(result) {
        		...
        		JOptionPane.showMessageDialog(null, "수정에 실패하였습니다 입력된 값을 확인하세요", "경고!!", JOptionPane.WARNING_MESSAGE);
        	}
           break;
